...
from the SMILES transformer \cite{} and representations of protein
amino acid sequences from DeepGOPlus \cite{}.
\name learns representations of drug effects and protein functions
using the ontology-based machine learning method DL2Vec \cite{}.
