...
split over DTI pairs, over drugs and over proteins, respectively,
where only in the latter two schemes unseen entities are guaranteed to
be shown to the model in the validation and testing
phase. Additionally, these schemes may have different expressiveness
and use different information in DTI prediction, as different
