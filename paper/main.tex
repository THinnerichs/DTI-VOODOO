...
drug to the protein).
\todo[inline]{There is a missing sentence here explaining the graph
  neural network, output, etc.}
We then train this model in an end-to-end manner using a graph neural
network architecture.  The overall workflow\todo{make sure it's a
  workflow} is depicted in Figure~\ref{fig:Fullmodel}.
