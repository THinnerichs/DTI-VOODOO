...
\abstract{\textbf{Motivation:} \textit{In silico} drug--target
  ...
  molecular information to directly predict binding potentials.
  Both approaches can be combined with information about interaction
  networks, 
  
  However, DTI datasets are prone to certain biases,
