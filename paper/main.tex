...
\begin{table*}
	...
	\begin{tabular}{|l|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}|}
		...
		\hline
		&&\multicolumn{3}{c|}{Yamanishi results}&\multicolumn{3}{c|}{BioSnap results}\\
		...
		\hline
	\end{tabular}
        \caption{\label{tab:comparison} Comparison of \name{} with
          state of the art drug--target interaction prediction methods
          (Yamanishi dataset) and drug--target affinity prediction
          methods (BioSnap dataset); we evaluated the original and the
