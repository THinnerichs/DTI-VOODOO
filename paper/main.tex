...
be identified. We use an evaluation measure based on micro-averaged
per protein (Micro AUC$_p$) to evaluate this application.


Finally, a potential source of differences in evaluation is how
negatives are treated during evaluation (and training).
Random sampling of unknown... 
...
Other biases: evaluate on balanced data, not all
