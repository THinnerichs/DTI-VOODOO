...
prediction methods use the guilt-by-association principle \cite{} and
assume that a protein is a likely target for a drug if many of the
protein's neighbors in the interaction network are targets of the
drug \cite{}. 
