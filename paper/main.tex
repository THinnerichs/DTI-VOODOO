...
them. \name{} is available as Free Software at \url{}\todo{add}.
...
subset:
\todo[inline]{Is the accuracy usually close to $1$? I am still not so
  sure this imputation with accuracy is well justified -- is there a
  precedent/paper to cite somewhere?}
\begin{equation*}
