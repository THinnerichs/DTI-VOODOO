...
all protein representations to the respective node features,
initializing the graph convolutional update steps. The resulting
representations are used for a similarity prediction similar to the
models presented in figure ~\ref{fig:HalfTwinNetwork}.
