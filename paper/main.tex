...
AUCs, \name{} improves significantly ($p<0.0001$, one-sided t-test)
over MolTrans, DeepDTI, DeepDTA, and DeepConv-DTI on the BioSnap
dataset, and significantly ($p<0.0001$, one-sided t-test) over DTINet
and DTIGEMS+ on the Yamanishi dataset' DTI-CDF performs
