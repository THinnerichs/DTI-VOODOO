...
of interactions between proteins; this property of \name{} relies on
the ability to integrate heterogeneous features using graphs, and the
ability to exploit this graph through the use of graph neural
networks.
