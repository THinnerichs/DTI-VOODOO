...
based on interactions between proteins, other types of entities and
interactions can also be chosen, in particular similarity networks
\cite{Gottlieb2011}; in such networks, information between nodes
may be transmitted differently than in \name{}.
...
\todo{TODO}Most of novel predictions made by \name{} are for antineoplastic
agents targeting proteins belonging to the Zinc finger, LIM-type
family ({\tt IPR001781}).
