...
prediction of protein functions \cite{Zitnik2017}, \todo{add 2 more,
  and then one on DTI prediction}.
...
$MicroAUC_p$, see Section \ref{sec:evaluation}) and evaluate\todo{Only
evaluate or retrain (from scratch)? Should say here.} them in a
...
under a precision-recall curve\todo{I note that we do not report AUPR
  -- why not?}.
