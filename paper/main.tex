...
$P_1$ interacting with $P_3$), we can only infer from the direct
neighborhood of each protein within the PPI graph. Our results (Table
...
\name{} introduces a number of novel 

While the exploitation of ontology based features over PPI graphs was already examined in \citet{Trebacz2020} for gene expression analysis, our work is the first to investigate and apply this technique to DTI prediction. Further, \name{} is the first work to combine both ``bottom-up'' and ``top-down'' features.  
