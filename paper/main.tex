...
averages (Micro AUC$_p$ and Micro AUC_$d$) to further illustrate how
...
methods. The bias we identify is similar to a previous bias found in
gene networks and methods that rely on the guilt-by-association
approach
\cite{}\todo{https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1002444}
but which has, to our knowledge, not been demonstrated in the context
of DTI prediction.
