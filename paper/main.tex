...
dimensionality and we first process them using a fully connected neural network
layer which takes as input an embedding and outputs a representation
of a particular size.
We use this as a trainable feature transformation.

An example structure for both types of features
