...
def better_missing_target_predictor(results_filename = '../results/results_log',
    ...
    for train, test in skf.split(protein_list):
        ...
        if embedding_method == 'gcn':
            graph_layer = GraphCNN(GCN_layer_sizes.pop(0),
                                   num_filters,
                                   graph_conv_filters,
            ...
            for size in GCN_layer_sizes:
                graph_layer = GraphCNN(size, num_filters,
                                       graph_conv_filters,
            ...
            for size in GCN_layer_sizes:
                graph_layer = GraphAttentionCNN(output_dim=size,
                                                adjacency_matrix=PPI_adj_mat,
                                                num_filters=num_filters,
                                                graph_conv_filters=graph_conv_filters,
