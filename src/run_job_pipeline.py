...
if __name__ == '__main__':
    ...
    for arch in ['GCNConv','SAGEConv', 'GATConv']:
        ...
        for fold in range(1, 2):
            ...
            submit_gpu_job(epochs=6, batch_size=160, days=2, arch=arch, fold=fold, num_gpus=8)
            ...
            submit_gpu_job(epochs=6, batch_size=160, days=2, arch='Res'+arch, fold=fold, num_gpus=8)
