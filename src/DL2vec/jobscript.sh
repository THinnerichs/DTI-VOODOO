...
python runDL2vec.py -embedsize 200 -ontology ../../data/drug_indications/UMLS.owl -associations ../../data/drug_indications/drug_indication_association_file -outfile ../../data/drug_indications/embedding_model -entity_list ../../data/drug_indications/drug_indication_entity_list -num_workers 64 -file_prefix drug_ind_
