...
use lib qw(/home/thinnerichs/meme/lib/meme-5.1.0/perl);
...
unless ($@) {
  Log::Log4perl::init('/home/thinnerichs/meme/share/meme-5.1.0/logging.conf');
  $logger = Log::Log4perl->get_logger('meme.service.utils');
}

my $service_invocation_log_dir = '/home/thinnerichs/meme/var/meme-5.1.0/LOGS';
my $tmpdir = '';
...
sub update_status {
  ...
  my $template = HTML::Template->new(filename => '/home/thinnerichs/meme/share/meme-5.1.0/job_status.tmpl');
